  ...
  init(){
    ...
    this.dashboardService.getDashboardData().subscribe((quiz_data)=>{
     ...
     quiz_data.map((quiz: any)=>{
            ...
            response_data.wrong_answers_count += quiz.quiz_config.amount - quiz.correct_answers_count
        ...
        this.doughnutChartData = [this.dashboard_data.correct_answers_count ,  this.dashboard_data.wrong_answers_count ]
